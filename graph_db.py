...
class CYOAGraphDB:
    ...
    def create_choice_edge(self, source_scene_id: str, target_scene_id: str, choice_text: str) -> None:
    ...
    def get_scene_history_path(self, current_scene_id: str) -> Optional[dict[str, Any]]:
        ...
        with self.driver.session() as session:
            ...
            scenes = [{"id": n["id"], "narrative": n["narrative"], "available_choices": n.get("available_choices", [])} for n in record["scenes"]]
